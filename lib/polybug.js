...
export default {
  ...
  debug(directory, commandLine) {
    if (!this.panel) {
      ...
      this.addButton('continue', 'Continue', () => this.sendCommand('continue'));
      this.addButton('step', 'Step', () => this.sendCommand('step'));
      this.addButton('next', 'Next', () => this.sendCommand('next'));
      this.addButton('return', 'Return', () => this.sendCommand('return'));
      this.addButton('restart', 'Restart', () => this.sendCommand('restart'));
